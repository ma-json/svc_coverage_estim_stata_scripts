...
* ======================================================================================================================
*   
*   Filename:		2a_Prepare_data_subdistrict
*   Author:			M Johnson
...
* 					Part 3: Create data files for completeness of reporting by subdistrict/year
* 					Part 4: Create data files to identify low reporting by subdistrict/year
* 					Part 5: Identify reported outliers by subdistrict/year
...
import excel "0c_vi_DHIMS2_template_svc_data_1_subd.xlsx", sheet("Sheet 1") firstrow case(lower) clear
save "0c_vi_DHIMS2_template_svc_data_1_subd.dta", replace

import excel "0c_vii_DHIMS2_template_svc_data_2_subd.xlsx", sheet("Sheet 1") firstrow case(lower) clear
save "0c_vii_DHIMS2_template_svc_data_2_subd.dta", replace

import excel "0c_viii_DHIMS2_template_svc_data_3_subd.xlsx", sheet("Sheet 1") firstrow case(lower) clear
save "0c_viii_DHIMS2_template_svc_data_3_subd.dta", replace

// merge files
use "0c_vi_DHIMS2_template_svc_data_1_subd.dta", clear

merge 1:1 orgunitlevel3 subdistrict_group year month using "0c_vii_DHIMS2_template_svc_data_2_subd.dta"
...
order orgunitlevel3 subdistrict_group year _month // order variables in the dataset
sort orgunitlevel3 subdistrict_group year _month // sort the dataset by listed variables

save "2a_i_DHIMS2_template_svc_data_all_subd.dta", replace


* import reporting completeness file
import excel "0c_xiii_DHIMS2_template_rep_compl_subd.xlsx", sheet("Sheet 1") firstrow case(lower) clear
...
order orgunitlevel3 subdistrict_group year _month
sort orgunitlevel3 subdistrict_group year _month

save "2a_ii_DHIMS2_template_rep_compl_all_subd.dta", replace
...
use "2a_i_DHIMS2_template_svc_data_all_subd.dta", clear

merge 1:1 orgunitlevel3 subdistrict_group year month using "2a_ii_DHIMS2_template_rep_compl_all_subd.dta"
list orgunitlevel3 subdistrict_group year month _merge if _merge != 3	//*Check discrepancy of key variables for merging
drop _merge

order orgunitlevel3 subdistrict_group year _month month
sort orgunitlevel3 subdistrict_group year _month
...
order orgunitlevel3 subdistrict_group year month date datex
sort orgunitlevel3 subdistrict_group year month

save "2a_v_DHIMS2_template_master_non_adjusted_dataset_subd.dta", replace
...
*-----------------------------------------------------------------------------------------------------------------------
* import data files
use "2a_v_DHIMS2_template_master_non_adjusted_dataset_subd.dta", clear

keep orgunitlevel3 subdistrict_group year month anc_rr idelv_rr pnc_rr vacc_rr opd_rr diar_rr ipd_rr fp_rr
...
foreach var of varlist anc_rr idelv_rr pnc_rr vacc_rr opd_rr diar_rr ipd_rr fp_rr {
	preserve
	collapse (mean) `var', by(orgunitlevel3 subdistrict_group year)
	save "_completeness_subdistrict`var'.dta", replace
	restore
}
...
save "2a_vii_DHIMS2_completeness_by_subdistrict_year.dta", replace
 			
local tmpfile: dir . files "_completeness_subdistrict*.dta"
...
reshape wide anc_rr fp_rr idelv_rr pnc_rr ipd_rr opd_rr diar_rr vacc_rr, i(orgunitlevel3 subdistrict_group) j(year)

* flag subdistricts with reporting completeness below the 'low' DQ threshold of 90% (i.e. % of expected health facilities with a reported value) by service type in 2017
gen lowc_17_anc = 0
...
lab var lowc_17_anc "Subdistrict with ANC reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_fp "Subdistrict with Family Planning reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_idelv "Subdistrict with institutional delivery reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_pnc "Subdistrict with PNC reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_vacc "Subdistrict with vaccination reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_opd "Subdistrict with OPD visits reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_opd "Subdistrict with (all ages) diarrhoea service events reporting below ${threshold_low_rr}% in 2017"
lab var lowc_17_ipd "Subdistrict with IPD admissions reporting below ${threshold_low_rr}% in 2017"
...
lab var lowc_18_anc "Subdistrict with ANC reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_fp "Subdistrict with Family Planning reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_idelv "Subdistrict with institutional delivery reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_pnc "Subdistrict with PNC reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_vacc "Subdistrict with vaccination reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_opd "Subdistrict with OPD visits reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_diar "Subdistrict with (all ages) diarrhoea service events reporting below ${threshold_low_rr}% in 2018"
lab var lowc_18_ipd "Subdistrict with IPD admissions reporting below ${threshold_low_rr}% in 2018"
...
lab var lowc_19_anc "Subdistrict with ANC reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_fp "Subdistrict with Family Planning reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_idelv "Subdistrict with institutional delivery reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_pnc "Subdistrict with PNC reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_vacc "Subdistrict with vaccination reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_opd "Subdistrict with OPD visits reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_diar "Subdistrict with (all ages) diarrhoea service events reporting below ${threshold_low_rr}% in 2019"
lab var lowc_19_ipd "Subdistrict with IPD admissions reporting below ${threshold_low_rr}% in 2019"
...
lab var lowc_20_anc "Subdistrict with ANC reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_fp "Subdistrict with Family Planning reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_idelv "Subdistrict with institutional delivery reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_pnc "Subdistrict with PNC reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_vacc "Subdistrict with vaccination reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_opd "Subdistrict with OPD visits reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_diar "Subdistrict with (all ages) diarrhoea service events reporting below ${threshold_low_rr}% in 2020"
lab var lowc_20_ipd "Subdistrict with IPD admissions reporting below ${threshold_low_rr}% in 2020"
...
save "2a_vii_DHIMS2_LOW_completeness_by_subdistrict_year.dta", replace
...
foreach var of varlist anc1 anc4 ipt2 idelv csection pnc48h bcg penta1 penta2 penta3 measles1 diar_total diar_under1 diar_under5 opd_total opd_under5 ipd_total ipd_under5 fp_total fp_new fp_revisits total_stillbirth stillbirth_f ///
	...
	bysort orgunitlevel3 subdistrict_group: egen rr_`var'_med = median(rr_`var') if rr_`var' >= 75
	bysort orgunitlevel3 subdistrict_group: egen max_rr_`var'_med = max(rr_`var'_med)
