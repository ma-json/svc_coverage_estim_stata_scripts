...
* ======================================================================================================================
*   
*   Filename:		1b_Assess_completeness_district
*   Author:			M Johnson
...
*-----------------------------------------------------------------------------------------------------------------------
* import data files
use "1a_v_DHIMS2_template_master_non_adjusted_dataset", clear

// apply adjustments prepared in script 1a_Prepare_data_district.do, part 5
...
save "1a_v_DHIMS2_template_master_non_adjusted_dataset", replace
...
* save dataset in stata format
save "1b_i_DHIMS2_master_completeness_adjusted_dataset.dta", replace
...
keep orgunitlevel3 year month anc1 anc4 ipt2 idelv csection pnc48h bcg penta1 penta2 penta3 measles1 diar_total diar_under1 diar_under5 opd_total opd_under5 ipd_total ipd_under5 fp_total fp_new fp_revisits total_stillbirth stillbirth_f ///
	stillbirth_m under5_deaths maternal_deaths na_*

foreach var of varlist anc1 anc4 ipt2 idelv csection pnc48h bcg penta1 penta2 penta3 measles1 diar_total diar_under1 diar_under5 opd_total opd_under5 ipd_total ipd_under5 fp_total fp_new fp_revisits total_stillbirth stillbirth_f ///
	stillbirth_m under5_deaths maternal_deaths na_* {
	bysort orgunitlevel3 year: gen _`var' = sum(`var')
	bysort orgunitlevel3 year: replace _`var' = _`var'[_N]
	preserve
	collapse (first) _`var', by(orgunitlevel3 year)
	save _orgunitlevel3_`var'.dta, replace
	restore
}

use "_orgunitlevel3_anc1", clear
local reshapeddistrict: dir . files "_orgunitlevel3_*.dta"
...
* save dataset in stata format
save "1b_ii_DHIMS2_compare_reported_adjusted_rates.dta", replace

local tmpfile: dir . files "_orgunitlevel3_*.dta"
