...
* ======================================================================================================================
*   
*   Filename:		2e_Produce_denominators_subdistrict.do
*   Author:			M Johnson
...
use "2c_iii_DHIMS2_master_adjusted_dataset.dta", clear
...
bysort orgunitlevel3 subdistrict_group year: egen subd_penta1 = total(penta1) // subdistrict total utilisation of service by year
...
bysort orgunitlevel3 subdistrict_group year: egen subd_inftpenta1 = total(inftpenta1) // subdistrict total eligible for Penta1 service by year
...
gen subd_cov_penta1 = 100 * subd_penta1 / subd_inftpenta1 // denominator for Penta1 is Penta1 (here derived from DHIMS2 Penta1)
lab var subd_cov_penta1 "Coverage of Penta1 based on DHIMS2 Penta1 denominator (subdistrict)"

// compute penta2 utilisation by year
sort orgunitlevel3 subdistrict_group year
bysort year: egen tot_penta2 = total(penta2) // annual total utilisation of Penta2 service
bysort orgunitlevel3 subdistrict_group year: egen subd_penta2 = total(penta2) // subdistrict total utilisation of Penta2 service by year
...
gen subd_cov_penta2 = 100 * subd_penta2 / subd_inftpenta1 // denominator for Penta2 is Penta1 (here derived from DHIMS2 Penta1)
lab var subd_cov_penta2 "Coverage of Penta2 based on DHIMS2 Penta1 denominator (subdistrict)"

// compute penta3 utilisation by year
sort orgunitlevel3 subdistrict_group year
bysort year: egen tot_penta3 = total(penta3) // annual total utilisation of Penta3 service
bysort orgunitlevel3 subdistrict_group year: egen subd_penta3 = total(penta3) // subdistrict total utilisation of Penta3 service by year
...
gen subd_cov_penta3 = 100 * subd_penta3 / subd_inftpenta1 // denominator for Penta3 is Penta1 (here derived from DHIMS2 Penta1)
lab var subd_cov_penta3 "Coverage of Penta3 based on DHIMS2 Penta1 denominator (subdistrict)"
...
bysort orgunitlevel3 subdistrict_group year: egen subd_measles1 = total(measles1) // subdistrict total utilisation of service by year
...
bysort orgunitlevel3 subdistrict_group year: egen subd_inftmeasle = total(inftmeasle) // subdistrict total eligible for service by year
...
gen subd_cov_measles1 = 100 * subd_measles1 / subd_inftmeasle // denominator for measles1 is measles1 (here derived from DHIMS2 Penta1)
lab var subd_cov_measles1 "Coverage of measles1 based on DHIMS2 Penta1 denominator (subdistrict)"
...
bysort orgunitlevel3 subdistrict_group year: egen subd_diar_under1 = total(diar_under1) // subdistrict total utilisation of service by year

// convert number of diarrhoea service events into number of service users
gen tot_diar_under1_users = tot_diar_under1 / 1.82
gen subd_diar_under1_users = subd_diar_under1 / 1.82
...
bysort orgunitlevel3 subdistrict_group year: egen subd_inftdiar = total(inftdiar) // subdistrict total eligible for service by year
...
gen subd_cov_diar_u1 = 100 * subd_diar_under1_users / subd_inftdiar // denominator for measles1 is measles1 (here derived from DHIMS2 Penta1)
lab var subd_cov_diar_u1 "Coverage of diarrhoea service (under 1s) based on DHIMS2 Penta1 denominator (subdistrict)"

save "2e_v_DHIMS2_master_adjusted_dataset_cov_estimates.dta", replace
