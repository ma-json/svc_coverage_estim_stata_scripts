...
* ======================================================================================================================
*   
*   Filename:		2b_Assess_completeness_subdistrict
*   Author:			M Johnson
...
*-----------------------------------------------------------------------------------------------------------------------
* import data files
use "2a_v_DHIMS2_template_master_non_adjusted_dataset_subd", clear

// apply adjustments prepared in script 2a_Prepare_data_subdistrict.do, part 5
...
save "2a_v_DHIMS2_template_master_non_adjusted_dataset_subd", replace
...
* save dataset in stata format
save "2b_i_DHIMS2_master_completeness_adjusted_dataset.dta", replace
...
keep orgunitlevel3 subdistrict_group year month anc1 anc4 ipt2 idelv csection pnc48h bcg penta1 penta2 penta3 measles1 diar_total diar_under1 diar_under5 opd_total opd_under5 ipd_total ipd_under5 fp_total fp_new fp_revisits total_stillbirth ///
	stillbirth_f stillbirth_m under5_deaths maternal_deaths na_*

foreach var of varlist anc1 anc4 ipt2 idelv csection pnc48h bcg penta1 penta2 penta3 measles1 diar_total diar_under1 diar_under5 opd_total opd_under5 ipd_total ipd_under5 fp_total fp_new fp_revisits total_stillbirth stillbirth_f ///
	stillbirth_m under5_deaths maternal_deaths na_* {
	bysort orgunitlevel3 subdistrict_group year: gen _`var' = sum(`var')
	bysort orgunitlevel3 subdistrict_group year: replace _`var' = _`var'[_N]
	preserve
	collapse (first) _`var', by(orgunitlevel3 subdistrict_group year)
	save _orgunitlevel3_subdistrict_group_`var'.dta, replace
	restore
}

use "_orgunitlevel3_subdistrict_group_anc1", clear
local reshapeddistrict: dir . files "_orgunitlevel3_subdistrict_group_*.dta"
...
* save dataset in stata format
save "2b_ii_DHIMS2_compare_reported_adjusted_rates.dta", replace
