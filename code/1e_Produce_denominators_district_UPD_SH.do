...
* ======================================================================================================================
*   
*   Filename:		1e_Produce_denominators_district.do
*   Author:			M Johnson
...
*-----------------------------------------------------------------------------------------------------------------------
* Part 2: Estimate coverage of Penta2 and Penta3 vaccinations based on denominators estimated from DHIMS2 Penta1 
* actvity ####
*-----------------------------------------------------------------------------------------------------------------------
...
sort orgunitlevel3 year
bysort year: egen tot_penta1 = total(penta1) // annual total utilisation of service
bysort orgunitlevel3 year: egen dist_penta1 = total(penta1) // district total utilisation of service by year
...
bysort orgunitlevel3 year: egen dist_inftpenta1 = total(inftpenta1) // district total eligible for Penta1 service by year
...
gen dist_cov_penta1 = 100 * dist_penta1 / dist_inftpenta1 // denominator for Penta1 is Penta1 (here derived from DHIMS2 Penta1)
lab var dist_cov_penta1 "Coverage of Penta1 based on DHIMS2 Penta1 denominator (district)"

// compute penta2 utilisation by year
sort orgunitlevel3 year
bysort year: egen tot_penta2 = total(penta2) // annual total utilisation of Penta2 service
bysort orgunitlevel3 year: egen dist_penta2 = total(penta2) // district total utilisation of Penta2 service by year
...
gen dist_cov_penta2 = 100 * dist_penta2 / dist_inftpenta1 // denominator for Penta2 is Penta1 (here derived from DHIMS2 Penta1)
lab var dist_cov_penta2 "Coverage of Penta2 based on DHIMS2 Penta1 denominator (district)"

// compute penta3 utilisation by year
sort orgunitlevel3 year
bysort year: egen tot_penta3 = total(penta3) // annual total utilisation of Penta3 service
bysort orgunitlevel3 year: egen dist_penta3 = total(penta3) // district total utilisation of Penta3 service by year
...
gen dist_cov_penta3 = 100 * dist_penta3 / dist_inftpenta1 // denominator for Penta3 is Penta1 (here derived from DHIMS2 Penta1)
lab var dist_cov_penta3 "Coverage of Penta3 based on DHIMS2 Penta1 denominator (district)"
...
bysort orgunitlevel3 year: egen dist_measles1 = total(measles1) // district total utilisation of service by year
...
bysort orgunitlevel3 year: egen dist_inftmeasle = total(inftmeasle) // district total eligible for service by year
...
gen dist_cov_measles1 = 100 * dist_measles1 / dist_inftmeasle // denominator for measles1 is measles1 (here derived from DHIMS2 Penta1)
lab var dist_cov_measles1 "Coverage of measles1 based on DHIMS2 Penta1 denominator (district)"
...
bysort orgunitlevel3 year: egen dist_diar_under1 = total(diar_under1) // district total utilisation of service by year

// convert number of diarrhoea service events into number of service users
gen tot_diar_under1_users = tot_diar_under1 / 1.82
gen dist_diar_under1_users = dist_diar_under1 / 1.82
...
bysort orgunitlevel3 year: egen dist_inftdiar = total(inftdiar) // district total eligible for service by year
...
gen dist_cov_diar_u1 = 100 * dist_diar_under1_users / dist_inftdiar // denominator for measles1 is measles1 (here derived from DHIMS2 Penta1)
lab var dist_cov_diar_u1 "Coverage of diarrhoea service (under 1s) based on DHIMS2 Penta1 denominator (district)"

save "1e_v_DHIMS2_master_adjusted_dataset_cov_estimates.dta", replace
